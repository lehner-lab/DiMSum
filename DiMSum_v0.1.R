...
option_list <- list(
  ...
  optparse::make_option(opt_str=c("--errorModelMaxSubstitutions"), type="integer", default=2, help = "Error model: maximum number of nucleotide substitutions used for error model fitting (default:2)"),
...
dimsum(
  ...
  errorModelMaxSubstitutions=arg_list[["errorModelMaxSubstitutions"]],
