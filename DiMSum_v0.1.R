...
option_list <- list(
  ...
  optparse::make_option(opt_str=c("--reverseComplement"), type="logical", default=F, help = "Reverse complement variant sequences before processing?"),
  ...
  optparse::make_option(opt_str=c("--mixedSubstitutions"), type="logical", default=F, help = "Are coding sequences with both synonymous and nonsynonymous substitutions allowed?"),
