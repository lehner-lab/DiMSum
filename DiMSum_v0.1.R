...
option_list <- list(
  ...
  optparse::make_option(opt_str=c("--bayesianDoubleFitness", "-y"), type="logical", default=F, help = "Fitness: improve double mutant fitness estimates using Bayesian framework (default:F)"),
  ...
  optparse::make_option(opt_str=c("--splitChunkSize", "-k"), type="integer", default=3758096384, help = "FASTQ file split chunk size in bytes (default:3758096384)"),
