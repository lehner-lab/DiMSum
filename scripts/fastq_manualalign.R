...
#' @param num_nuc Enforced alignment length in base pairs (required)
...
#' @param concatentate_reads Simply concatentate reads (without reverse complementing second read in pair) (default: FALSE)
#'
#' @return Nothing
#' @export
