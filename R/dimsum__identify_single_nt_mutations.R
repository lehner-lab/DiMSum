...
dimsum__identify_single_nt_mutations <- function(
  ...
  singles_silent <- singles_silent[,cbind(Pos,WT_AA,Mut,merge_seq,Nham_nt,Nham_aa,Nmut_codons,STOP,STOP_readthrough,mean_count,.SD),,.SDcols = grep("_uncorr", names(singles_silent))]
